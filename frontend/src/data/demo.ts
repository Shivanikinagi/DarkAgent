...
export const demoBlinks: BlinkDraft[] = [
  {
    ...
    tweetCopy: 'Rotation alert: moving into ETH strength.',
  },
  {
    ...
    tweetCopy: 'This is the next 50x. Blink is live.',
  },
  {
    title: 'AI size too large',
    source: 'ai_bot',
    action: 'swap',
    tokenIn: 'USDC',
    tokenOut: 'ETH',
    ...
    chain: 'Solana',
    referralTag: '@DeepTrendBot',
    tweetCopy: 'Momentum confirmed, scaling the position.',
  },
]
